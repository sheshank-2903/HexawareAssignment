...
public class CustomerServiceImp implements ICustomerService {
	...
	public CustomerProductVO getCustomerAndProductById(int customerId) {
		...
		int pid = customerDTO.getCustomerId();
	...
	@Override
	public String deleteProductByCustomerId(int customerId) {
		CustomerDTO customerDTO = getCustomerById(customerId);
...
//		}
	...
	@Override
	public Product updateProductByCustomerId(int customerId) {
		CustomerDTO customerDTO = getCustomerById(customerId);

		int pid = customerDTO.getProductId();

		Product product=restTemplate.getForObject("http://localhost:8282/api/products/add", Product.class);
