...
public class Department {
	...
	@OneToMany(cascade=CascadeType.ALL,mappedBy="department") //should  be used to make bidirectional -- should be bidirectional
	//Join statment is not required
	...
	public void addEmployees(Employees employees) {
		...
		employees.setDepartment(this); // required for ManyToOne
